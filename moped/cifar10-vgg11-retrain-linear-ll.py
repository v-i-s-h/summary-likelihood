...
def main():
    ...
    model.load_state_dict(torch.load("cifar10-vgg11bn-moped-ll-1.pth")) # load pretrained BNN weights
    print("-------")
    ...
    torch.save(model.state_dict(), "cifar10-vgg11bn-moped-linear-ll-2.pth")

    # Save logs
    with open('retrain_logs_linear.pkl', 'wb') as f:
        pickle.dump({
            'tr': {
                'err': tr_err,
                'ece': tr_ece,
