# Script for training CIFAR10 VGG16 using MOPED
...
def main():
    ...
    batch_size = 128
    trainset = CIFAR10(root="./../data/", train=False, transform=transform, download=False)
    ...
    valset = CIFAR10(root="./../data/", train=True, transform=transform, download=False)
    ...
    # Save model
    torch.save(model.state_dict(), "cifar10-vgg11bn-moped.pth")
